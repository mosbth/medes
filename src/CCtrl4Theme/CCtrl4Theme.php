   ...
   */
	...
	public function __construct() {
		...
		$nav = array(
			array(
				'text'=>'1 column',
				'href'=>$pp->req->CreateUrlToControllerAction(),
			),
			array(
				'text'=>'Sidebar1',
				'href'=>$pp->req->CreateUrlToControllerAction(null, 'sidebar1'),
			),
			array(
				'text'=>'Sidebar2',
				'href'=>$pp->req->CreateUrlToControllerAction(null, 'sidebar2'),
			),
			array(
				'text'=>'Sidebar1&2',
				'href'=>$pp->req->CreateUrlToControllerAction(null, 'sidebar12'),
			),
		);
